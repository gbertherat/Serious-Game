...
/**
 * Permet la créé de composants JSwing
 * @author Guillaume
 */
public class Factory {
	 ...
	 * @param editable - Si le JTextField peut être modifié
	 ...
	 * @param editable - Si l'area peut être modifié
	 * @return un JTextArea
	 */
	 ...
	 * @param current - La valeur selectionnée
	 * @return un JSlider
	 */
